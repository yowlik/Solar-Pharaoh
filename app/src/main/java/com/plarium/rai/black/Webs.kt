...
import com.plarium.rai.black.CNST.MAIN_ID
import com.plarium.rai.databinding.ActivityWebsBinding
import org.json.JSONException
import org.json.JSONObject
import java.io.File
import java.io.IOException

class Webs : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebsBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebsBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "divinegate.xyz/go.php?to=2&"
